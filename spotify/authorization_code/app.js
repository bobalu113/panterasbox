...
var client_id = '0b407a5f31194bf5bbc405ea0edd9bba'; // Your client id
var client_secret = 'b29d89974b6b408abd51d60d3230e954'; // Your client secret
var redirect_uri = 'http://localhost:4071/callback'; // Your redirect uri
...
app.get('/dashboard', function(req, res) {
  ...
  request.get({
    ...
    request.get({
      url: 'https://api.spotify.com/v1/users/' + out.id + '/playlists',
//      url: 'https://api.spotify.com/v1/users/' + out.id + '/playlists/04HFUuMrDpKkADrl0PXJam/tracks',
      headers: { 'Authorization': 'Bearer ' + access_token },
      json: true
    }, function(error, response, body) {
